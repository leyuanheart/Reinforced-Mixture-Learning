...
dats.append(np.load('./results/model-based/p3_K4/n100.npy'))
dats.append(np.load('./results/model-based/p3_K4/n200.npy'))
dats.append(np.load('./results/model-based/p3_K4/n300.npy'))
dats.append(np.load('./results/model-based/p3_K4/n400.npy'))
